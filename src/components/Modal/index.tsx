...
export default function ChangeBudgetStatusModal({ open, close }: ModalProps) {
  ...
  const openWhatsapp = () => {
    window.open(
      "https://wa.me/send?text=Ja%20viu%20a%20nova%20Intligencia%20Artificial%20Juridica?%0AAcesse%20para%20saber%20os%20benficios:%0Ahttps://listadeespera.juridia.com.br"
    );
  };
    ...
    <Container show={open} onHide={close} size="lg" data-backdrop="false">
      <Content>
        <ModalContent>
          ...
          <FormText>
            <Title size={25} marginTop="30px" color="#fff">
